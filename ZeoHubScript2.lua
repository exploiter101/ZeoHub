...
local function showQBreachingCover()
    ...
    -- Soft blurred background (deep orange-brown)
    local bg = Instance.new("Frame", gui)
    bg.Name = "BG"
    bg.Size = UDim2.new(1,0,1,0)
    bg.Position = UDim2.new(0,0,0,0)
    bg.BackgroundColor3 = Color3.fromRGB(36, 21, 0)
    ...
    shadow.ImageColor3 = Color3.fromRGB(255, 159, 64)
    ...
    frame.BackgroundColor3 = Color3.fromRGB(96, 64, 24)
    ...
    ring.ImageColor3 = Color3.fromRGB(255, 168, 36)
    ...
    qCircle.BackgroundColor3 = Color3.fromRGB(255, 200, 120)
    ...
    qTail.BackgroundColor3 = Color3.fromRGB(255, 200, 120)
    ...
    for i=1,10 do
        ...
        rain.TextColor3 = Color3.fromRGB(255, 183, 77)
    ...
    status.TextColor3 = Color3.fromRGB(255, 230, 180)
    ...
    substatus.TextColor3 = Color3.fromRGB(255, 204, 128)
    ...
    progressBarBg.BackgroundColor3 = Color3.fromRGB(110, 60, 10)
    ...
    progressBar.BackgroundColor3 = Color3.fromRGB(255, 183, 77)
    ...
    brand.Text = "Q"
    brand.TextColor3 = Color3.fromRGB(255, 168, 36)
    ...
    coroutine.wrap(function()
        ...
        while running and gui.Parent do
            t = t + 1
            -- Q color animation: orange hue
            local hue = 0.092 + ((tick() * 0.12) % 0.12) -- stays in orange
...
local function showQBreachingCover()
    ...
    progressBarBg.Size = UDim2.new(0.60, 0, 0.07, 0)
    progressBarBg.Position = UDim2.new(0.28, 0, 0.63, 0)
    progressBarBg.BackgroundColor3 = Color3.fromRGB(255, 128, 56)
    progressBarBg.BackgroundTransparency = 0.22
    progressBarBg.BorderSizePixel = 0
    local barCorner = Instance.new("UICorner", progressBarBg)
    barCorner.CornerRadius = UDim.new(0, 8)
